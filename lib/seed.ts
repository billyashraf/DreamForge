...
const INITIAL_MISSIONS = [
  ...
  // --- Metapolis ---
  {
    ...
    difficulty: "easy",
    type: "solo",
    rewards: { experience: 45, credits: 90 },
    requirements: { level: 1 },
    durationMinutes: 5,
  },
  {
    ...
    difficulty: "easy",
    type: "solo",
    rewards: { experience: 70, credits: 85 },
    requirements: { level: 1 },
    durationMinutes: 5,
  },
  {
    ...
    difficulty: "medium",
    type: "solo",
    rewards: { experience: 160, credits: 200 },
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "solo",
    rewards: { experience: 220, credits: 320 },
    requirements: { level: 5 },
    durationMinutes: 15,
  },
  // --- Moon Junkyard ---
  {
    ...
    difficulty: "easy",
    type: "solo",
    rewards: { experience: 90, credits: 110 },
    requirements: { level: 2 },
    durationMinutes: 5,
  },
  {
    ...
    difficulty: "medium",
    type: "solo",
    rewards: { experience: 190, credits: 240 },
    requirements: { level: 4 },
    durationMinutes: 10,
  },
  {
    ...
    difficulty: "hard",
    type: "solo",
    rewards: { experience: 380, credits: 450 },
  ...
  },
  {
    ...
    difficulty: "hard",
    type: "team",
    rewards: { experience: 480, credits: 580 },
    requirements: { level: 8, teamSize: 2 },
    durationMinutes: 25,
  },
  // --- Earth ---
  {
    ...
    difficulty: "medium",
    type: "solo",
    rewards: { experience: 280, credits: 360 },
    requirements: { level: 5 },
    durationMinutes: 15,
  },
  {
    ...
    difficulty: "medium",
    type: "solo",
    rewards: { experience: 310, credits: 420 },
    requirements: { level: 6 },
    durationMinutes: 20,
  },
  {
    ...
    difficulty: "hard",
    type: "solo",
    rewards: { experience: 450, credits: 520 },
  ...
  },
  {
    ...
    difficulty: "hard",
    type: "team",
    rewards: { experience: 560, credits: 650 },
    requirements: { level: 8, teamSize: 2 },
    durationMinutes: 30,
  },
  // --- Mars ---
  {
    ...
    difficulty: "hard",
    type: "solo",
    rewards: { experience: 650, credits: 800 },
    requirements: { level: 10 },
    durationMinutes: 20,
  },
  {
    ...
    difficulty: "hard",
    type: "solo",
    rewards: { experience: 820, credits: 1000 },
  ...
  },
  {
    ...
    difficulty: "legendary",
    type: "solo",
    rewards: { experience: 1800, credits: 2500 },
  ...
  },
  {
    ...
    difficulty: "legendary",
    type: "guild",
    rewards: { experience: 4000, credits: 7000 },
